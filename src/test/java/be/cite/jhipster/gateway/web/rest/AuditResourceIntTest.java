...
import be.cite.jhipster.gateway.config.audit.AuditEventConverter;
import be.cite.jhipster.gateway.domain.PersistentAuditEvent;
import be.cite.jhipster.gateway.repository.PersistenceAuditEventRepository;
import be.cite.jhipster.gateway.service.AuditEventService;
